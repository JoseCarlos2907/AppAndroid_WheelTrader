...
fun RecuperarContrasenia1(
    ...
    LaunchedEffect(loginUiState.goToCodigo) {
        if(loginUiState.goToCodigo){
            goToCodigo()
        }
    }
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = "Para recuperar la contraseña de tu cuenta te enviaremos un correo con un código que tendrás que escribir en el siguiente paso. Escribe el correo de la cuenta",
        ...
        Row(
            ...
            Card(
                ...
                Column(
                    ...
                    OutlinedTextField(
                        value = recuperarContraseniaUiState.correo,
                        onValueChange = { recuperarContraseniaViewModel.onCorreoChange(it) },
                        placeholder = {
                            Text(
                                text = "Correo",
            ...
            Button(
                onClick = {
                    loginViewModel.viewModelScope.launch(Dispatchers.IO) {
                        loginViewModel.recuperarContrasenia_Correo(recuperarContraseniaUiState.correo)
                    }
                },
